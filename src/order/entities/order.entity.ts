...
export class Paystack {
  ...
  @OneToMany(() => OrderItem, (item) => item, { cascade: true, eager: true })
  orderItems: OrderItem[];
...
export class Order {
  ...
  @OneToOne(() => Paystack, { cascade: true, eager: true })
  @JoinColumn()
  payStackPayment: Paystack;
  ...
  @OneToOne(() => DeliveryStatus, { cascade: true, eager: true })
  @JoinColumn()
  deliveryStatus: DeliveryStatus;
  ...
  @OneToMany(() => DeliveryComment, (comment) => comment, {
    cascade: true,
    eager: true,
  })
  deliveryComment: DeliveryComment[];
